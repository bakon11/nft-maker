export const checkConditionalsHumans = async ( selectedLayers ) => {
	let check;
	const checkTheStuff = async ( excluded ) => {
	...
	if ( 
		...
		return await checkTheStuff(excluded);
	};
	...
	if ( 
		...
		let excluded = [ "Snorkel_and_Goggles", "Laser_Beams" ];
		return await checkTheStuff(excluded);
	};
	...
	if ( 
		...
		let excluded = [ "Atomic_Pipe", "Cigarette", "Doobie", "Dynamite", "Forked_Tongue", "Mouse_Prey", "Paintbrush", "Pipe", "Pipe_Tornado", "Snorkel", "Diving_Bell" ];
		return await checkTheStuff(excluded);
	};
	...
	if ( 
		...
		let excluded = [ "Arrow", "Bicorn", "Bomber_Cap", "Bomber_Cap_Long", "Bomber_Cap_Black_Long_Dreads", "Captain", "Captain_Cornrows", "Captain_Minoan", "Cobra_Crown", "Cowboy_Hat", "Cowboy_Hat_Black_Long_Dreads", "Derby", "Derby_Black_Long_Dreads", "Derby_Long",
			"Diving_Bell", "Fez", "Fez_Long", "First_Mate", "Halo", "Headband", "Headband_Long", "Hopi_Headdress", "Jester", "Jeweled_Crown", "Jeweled_Diadem", "Miss_Antoinette", "Mouse_Prey", "Nurse", "Paintbrush", "Raspberry_Beret", "Rastafari", "Rastafari_Brown_Long_Dreads", "Saiyan", 
			...
			"Visko_Helmet_Long", "Visko_Helmet_Pink", "Witch_Hat", "Witch_Hat_Black_Long_Dreads", "Wizard_Cap", "Wizard_Cap_Minoan", "Woodland_Fae", "Woodland_Fae_Minoan", "Woodland_Fae_Black_Long_Dreads", "Dynamite", "Snorkel" ];
		return await checkTheStuff(excluded);
	};
